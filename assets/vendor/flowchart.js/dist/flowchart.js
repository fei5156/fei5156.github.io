        ...
        function (module, exports, __webpack_require__) {
            ...
            Symbol.prototype.getAttr = function (attName) {
                ...
                if (this.next) {
                    ...
                    if ("right" === this.next_direction) {
                        ...
                        if (!this.next.isPositioned) {
                            ...
                            var self = this;
                            !function shift() {
                                for (var symb, hasSymbolUnder = !1, i = 0,
                                         len = self.chart.symbols.length; len > i; i++) {
                ...
                if (//update line style
                    ...
                    for (var l = 0, llen = this.chart.lines.length; llen > l; l++) for (var len,
                                                                                            otherLine = this.chart.lines[l],
                                                                                            ePath = otherLine.attr("path"),
                                                                                            lPath = line.attr("path"),
                                                                                            iP = 0,
                                                                                            lenP = ePath.length - 1; lenP > iP; iP++) {
                        var newPath = [];
                        newPath.push(["M", ePath[iP][1], ePath[iP][2]]), newPath.push(["L", ePath[iP + 1][1], ePath[iP + 1][2]]);
                        for (var line1_from_x = newPath[0][1], line1_from_y = newPath[0][2], line1_to_x = newPath[1][1],
                                 line1_to_y = newPath[1][2], lP = 0, lenlP = lPath.length - 1; lenlP > lP; lP++) {
                            var newLinePath = [];
        ...
        function (module, exports, __webpack_require__) {
            function parse(input) {
                ...
                for (var chart = {
                    ...
                    }, lines = [], prevBreak = 0, i0 = 1,
                         i0len = input.length; i0len > i0; i0++) if ("\n" === input[i0] && "\\" !== input[i0 - 1]) {
                ...
                for (; lines.length > 0;) {
                    ...
                    if (line.indexOf("=>") >= 0) {
                        ...
                        if (params && params.length > 1) for (var entries = params[1].split(","),
                    ...
                    } else if (line.indexOf("->") >= 0) for (var flowSymbols = line.split("->"), i = 0,
                                                                 lenS = flowSymbols.length; lenS > i; i++) {
                    ...
                    } else if (line.indexOf("@>") >= 0) for (var lineStyleSymbols = line.split("@>"), i = 0,
                                                                 lenS = lineStyleSymbols.length; lenS > i; i++) if (i + 1 != lenS) {
            ...
            inherits(Condition, Symbol), Condition.prototype.render = function () {
                ...
                if (this.right_symbol) {
                    ...
                    if (!this.right_symbol.isPositioned) {
                        ...
                        !function shift() {
                            for (var symb, hasSymbolUnder = !1, i = 0,
                                     len = self.chart.symbols.length; len > i; i++) if (symb = self.chart.symbols[i],
